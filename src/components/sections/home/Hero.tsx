...
const DEFAULT_HERO = {
  ...
  title: 'Scale your SaaS business with',
  titleHighlight: 'intelligent automation',
  description:
    'Transform your customer data into actionable insights. Our AI-driven platform helps SaaS companies reduce churn by 40% and increase revenue by 60%.',
  features: [
  ...
  statsLabel1: 'Customer Retention',
  statsValue1: '+40% increase',
  statsLabel2: 'Revenue Growth',
  statsValue2: '+60% boost',
} as const;
