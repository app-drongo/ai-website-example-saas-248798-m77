...
export default function Footer({
  ...
  companyDescription = 'Streamline your workflow with our comprehensive SaaS platform. Trusted by over 10,000 businesses worldwide to automate processes, boost productivity, and drive growth.',
  ...
  newsletterDisclaimer = 'Get feature updates, tips, and exclusive offers. Unsubscribe anytime.',
  section1Title = 'Platform',
  section2Title = 'Company',
  section3Title = 'Support',
  section4Title = 'Legal',
  copyrightText = '© 2024 Example SaaS. All rights reserved.',
  madeWithText = 'by the Example SaaS team',
